          ...
          <Card.Content>
            <View style={styles.horizontalStyle}>
              <RadioButton
                value="perro"
                status={
                  checkedTipoMascota === "perro" ? "checked" : "unchecked"
                }
                onPress={() => cambiarTipoMascota("perro")}
              />
              <Image
                style={{ width: 50, height: 50 }}
                source={require("../../assets/index/Icono_Peluqueria.png")}
              />
              <Text>Woof</Text>
              <RadioButton
                value="gato"
            ...
            <View style={styles.verticalStyle}>
              ...
              <View style={styles.horizontalStyle}>
                <RadioButton
                  value="edad_madura"
                  status={
                    checkedEdad === "edad_madura" ? "checked" : "unchecked"
                  }
