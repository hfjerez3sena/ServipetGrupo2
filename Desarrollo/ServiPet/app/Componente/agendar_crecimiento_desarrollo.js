...
export default function AgendarCrecimientoDesarrollo(props) {
      ...
      >
        <Card.Content>{
            <View>
                ...
                <Text style={styles.titleThreeStyle}>Reemplazar este texto por el que corresponde. Se mostrará un texto rojo con información de pre-requisitos necesarios.</Text>
                <Card
        style={{
          flexDirection: "row",
          margin: 10,
      ...
      >
        <Card.Content>{
          ...
          <View style={styles.textInputImageStyle}>
            <Image source = {require("./imagenes/Icono__Cirugías.svg")} style={styles.imageTwo}/>
            <TextInput style={styles.freeTextInputStyle} placeholder="dd-mm-year" /> 
          </View>
          <Text style={styles.textViewOne} >Hora:</Text>
          <View style={styles.textInputImageStyle}>
            <Image source = {require("./imagenes/Icono__Cirugías.svg")} style={styles.imageTwo}/>
            <TextInput style={styles.freeTextInputStyle} placeholder="00: 00 am" /> 
          </View>
          <Text style={styles.textViewOne} >Observaciones:</Text>
          <Text style={styles.textViewThree} >Cuentanos si tu mascota tiene alguna alergia, enfermedad o requiere algun cuidado especial</Text>
          <View style={styles.textInputImageStyle}>
